...
# Mclust
#adata4 = adata.copy()
#adata4 = MCSER_GATE(adata = adata4, n_clusters = n, spatial_rad_cutoff = 50, clustering_algo='Mclust')
...
# Leiden
#adata5 = adata.copy()
#adata5 = MCSER_GATE(adata = adata3, n_clusters = n, spatial_rad_cutoff = 50, clustering_algo='Leiden')
...
if section_id == 'Slice2':
    ...
    sc.pl.spatial(adata7, color='MCSER_spatial_domains', cmap = 'tab20', save='baristaseq_'+section_id+'.png', spot_size=20)
