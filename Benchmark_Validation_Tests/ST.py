...
#For ST, we combine topological features with the STAGATE embedding
#Load Data
section_id = sys.argv[1]
adata = sc.read('/mnt/home/cottre61/TAST/Data/'+section_id+'.h5ad')
...
for i in range(10):
    adata2 = adata.copy()
    STAGATE.Cal_Spatial_Net(adata2, rad_cutoff=2)
